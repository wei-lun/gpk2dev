<?php
// --------------------------
// Features:	 收集產生瀏覽器的指紋碼，及遠端的 remote IP及觀看使用者的裝置資訊
...
// no script register
	...
	// 設定認證 key , 避免被使用者強行注入，透過手動增加, 一分鐘後失效。
	...
	$html = '
  <script src="'.$cdnfullurl_js.'fingerprint2.js"></script>
	...
	$(document).ready(function(){
      ...
      // console.log(components) // an array of FP components
			...
			$.post("fingerprintsession_action.php", {fingertracker: result, k: key_sha1 }, function(result){
