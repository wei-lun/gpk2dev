...
var jspath = getJsPath('head_m.js');
...
/*<!-- mobile -->*/
if (getParam(jspath, 'mode') == "mobile") {
    document.write("<script src='" + cdnurl + "m/js/swiper.min.js'></script>");
    document.write("<link rel='stylesheet' href='" + cdnurl + "m/css/swiper.min.css'>");
    document.write("<link rel='stylesheet' href='" + cdnurl + "css/common_m.css'>");
