...
<head>
	    ...
	    <!-- custom -->
		<link type="text/css" rel="stylesheet" href="<?php echo $cdnfullurl ?>css/style.css?version_key=190201">
	...
	<body id="main">
	  ...
	  <!-- header -->
		<div id="header">
		  <div class="hLinkBox clearfix">
				<button onclick="javascript:window.close();" class="weltitle" style="background:transparent;border: 0px;float:left"><span class="glyphicon glyphicon-remove-circle"></span></button>
				<ul class="d-flex ml-auto menu_admin" style="float:right">
					  <?php
	  ...
	  <!-- end header-->
			...
			<!-- Main-->
			<div id="gamescreen" width="100%" height="100%">
									<?php
							// 工作區內容
