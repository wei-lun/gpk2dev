...
<head>
        ...
        <!-- custom -->
        <link type="text/css" rel="stylesheet" href="<?php echo $cdnfullurl ?>css/style.css?ver_key_m=181228">
			...
			<div id="main" class="container">
				...
				<!--手機不顯示Breadcrumb
					...
					<div class="card login2-pc-m">
								...
								-->
								<div class="card-body login2-pc-m-logonbox">
