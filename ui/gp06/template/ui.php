...
//gp06 logo
$background_size='';
if($template=='admin' OR $template == 'member')
{
	$background_size='auto';
}
else{$background_size='100%';}

if($template != 'home')//有些樣板home 沒有header登入系統
{ 
  $header_login=
' <div class="headbottom">
    <div class="headlogin clearfix">
      <div class="rform">
        ...
        <div class="hInfo clearfix">
          <ul class="menu_top">
            <h1 class="logo"><a href="'.$config['website_baseurl'].'">
              <div class="logo-img" style="background: url('. $cdn_url_logo.') no-repeat center center;background-size: '.$background_size.';">
              </div>'.$membercenter.'
              </a></h1>
                    '// 左側選單(語言切換列)
...
<!-- Marquee-->
			<div class="marqueeSection"><div class="w1110">'// 跑馬燈
            .Scroll_marquee().'</div></div>';
