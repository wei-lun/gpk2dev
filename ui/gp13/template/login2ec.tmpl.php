							...
							<div class="col-xs-7 col-md-7">
								<nav>
									<ul class="nav nav-pills pull-right navbar-right">
										<li><a href="#" target="_self"><span class="glyphicon glyphicon-asterisk" aria-hidden="true"></span>關於我們</a></li>
										...
										<li><a href="<?php echo $config['website_baseurl'];?>" target="_self"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span>返回首頁</a></li>
									</ul>
								</nav>
							</div>
						</div>
				...
				<div class="container">
					<div class="row h_mid">
						<div class="col-xs-5 col-md-5 h_logo">
							...
							<span><?php echo $tr['EC Login']; ?></span>
						</div>
