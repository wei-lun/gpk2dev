 ...
 generate:'notclassified'
  ...
  '.national_agent().'
    ...
    <!-- 內容顯示區 -->
		...
		$gamelist_template['mctag_item'] = '<div id="index_mhot_{mctid}" class="row index_m_title"><div class="col-12"><h5>
    <span class="h5-gametag">{mct_name}</span>
    <span class="index_m_title_more"><a href="gamelobby.php?mgc={mctid}&t=hotgames">'.$tr['more'].'&gt;</a></span></h5></div></div><div id="gametable_{mctid}"><div class="row test"></div></div>';
