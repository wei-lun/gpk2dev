							...
							<div class="col-xs-7 col-md-7">
								<nav>
									<ul class="nav nav-pills pull-right">
										<li>
											<a href="<?php echo $config['website_baseurl'];?>aboutus.php" target="_self">
												<span class="glyphicon glyphicon-asterisk" aria-hidden="true"></span>
												<?php echo $tr['About us']; ?>
											</a>
										</li>
										<li>
											<a href="<?php echo $config['website_baseurl'];?>partner.php" target="_self">
												<span class="glyphicon glyphicon-star" aria-hidden="true"></span>
												<?php echo $tr['Partner']; ?>
											</a>
										</li>
										<li>
											<a href="<?php echo $config['website_baseurl'];?>" target="_self">
												<span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span>
												<?php echo $tr['Return Home']; ?>
											</a>
										</li>
									</ul>
								</nav>
