							...
							<div class="col-xs-7 col-md-7">
								<nav>
									<ul class="nav nav-pills pull-right">
											<li class="topreturn"><a href="<?php echo $config['website_baseurl'];?>" target="_self"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span>返回首頁</a></li>
									</ul>
								</nav>
							</div>
						</div>
				...
				<div class="container">
					<div class="row h_mid">
						<div class="col-xs-5 col-md-5 h_logo">
							...
							<span><?php echo $tr['Free account']; ?></span>
						</div>
